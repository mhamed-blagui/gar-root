...
@Configuration
public class GarJavaMelodyConfig implements ServletContextInitializer {
	@Override
	...
	public FilterRegistrationBean javaMelody() {
		...
		javaMelody.setDispatcherTypes(DispatcherType.REQUEST,
				DispatcherType.ASYNC);
		javaMelody.addInitParameter(Parameter.LOG.getCode(),
	...
	/**
	 * For monitoring of all services and controllers (even without having
	 * @MonitoredWithSpring):
	 * 
	 * @return MonitoringSpringAdvisor
	 */
	...
	public MonitoringSpringAdvisor springRestControllerMonitoringAdvisor() {
		final MonitoringSpringAdvisor interceptor = new MonitoringSpringAdvisor();
		interceptor.setPointcut(new AnnotationMatchingPointcut(
